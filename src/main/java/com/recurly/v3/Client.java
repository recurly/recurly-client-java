...
public class Client extends BaseClient {
   ...
   */
  public ExternalAccountResponse createAccountExternalAccount(String accountId, ExternalAccount body) {
    final String url = "/accounts/{account_id}/external_accounts";
    final HashMap<String, String> urlParams = new HashMap<String, String>();
    urlParams.put("account_id", accountId);
    final String path = this.interpolatePath(url, urlParams);
    Type returnType = ExternalAccountResponse.class;
    return this.makeRequest("POST", path, body, returnType);
  }
   ...
   */
  public ExternalAccountResponse getAccountExternalAccount(String accountId, String externalAccountId) {
   ...
   */
  public ExternalAccountResponse updateAccountExternalAccount(String accountId, String externalAccountId, ExternalAccount body) {
    final String url = "/accounts/{account_id}/external_accounts/{external_account_id}";
    final HashMap<String, String> urlParams = new HashMap<String, String>();
    urlParams.put("account_id", accountId);
    urlParams.put("external_account_id", externalAccountId);
   ...
   *
   * @see <a href="https://developers.recurly.com/api/v2021-02-25#operation/deleteAccountExternalAccount">deleteAccountExternalAccount api documentation</a>
   * @param accountId Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param externalAccountId External account ID, e.g. `s28zov4fw0cb`.
     * @return Successful Delete
   */
  public ExternalAccountResponse deleteaccountexternalaccount(String accountId, String externalAccountId) {
    final String url = "/accounts/{account_id}/external_accounts/{external_account_id}";
    final HashMap<String, String> urlParams = new HashMap<String, String>();
    urlParams.put("account_id", accountId);
    urlParams.put("external_account_id", externalAccountId);
