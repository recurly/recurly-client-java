...
- `verify` – a $0 or $1 transaction used to verify billing information which is immediately voided.
  ...
  public Constants.AvsCheck getAvsCheck() { return this.avsCheck; }
  ...
  public void setAvsCheck(final Constants.AvsCheck avsCheck) { this.avsCheck = avsCheck; }
  ...
  public Boolean getBackupPaymentMethodUsed() { return this.backupPaymentMethodUsed; }

  
  /**
   * @param backupPaymentMethodUsed Indicates if the transaction was completed using a backup payment
   */
  
  public void setBackupPaymentMethodUsed(final Boolean backupPaymentMethodUsed) { this.backupPaymentMethodUsed = backupPaymentMethodUsed; }

  
  public AddressWithName getBillingAddress() { return this.billingAddress; }
  ...
  public void setBillingAddress(final AddressWithName billingAddress) { this.billingAddress = billingAddress; }
  ...
  /**
   * @param customerMessage For declined (`success=false`) transactions, the message displayed to the customer.
   */
  ...
  public void setCvvCheck(final Constants.CvvCheck cvvCheck) { this.cvvCheck = cvvCheck; }
  ...
  /**
   * @param gatewayResponseCode For declined transactions (`success=false`), this field lists the gateway error code.
   */
  ...
  public BigDecimal getGatewayResponseTime() { return this.gatewayResponseTime; }
  ...
  public void setGatewayResponseTime(final BigDecimal gatewayResponseTime) { this.gatewayResponseTime = gatewayResponseTime; }
  ...
  public Map getGatewayResponseValues() { return this.gatewayResponseValues; }
  ...
  public void setGatewayResponseValues(final Map gatewayResponseValues) { this.gatewayResponseValues = gatewayResponseValues; }
  ...
  /**
   * @param ipAddressCountry Origin IP address country, 2-letter ISO 3166-1 alpha-2 code, if known by Recurly.
   */
...
- When the merchant enters billing information using the UI, no IP address is recorded.
  ...
  public Constants.TransactionOrigin getOrigin() { return this.origin; }
  ...
  public void setOrigin(final Constants.TransactionOrigin origin) { this.origin = origin; }
  ...
  /**
   * @param originalTransactionId If this transaction is a refund (`type=refund`), this will be the ID of the original transaction on the invoice being refunded.
   */
  ...
  public Constants.TransactionStatus getStatus() { return this.status; }

  
  /**
   * @param status The current transaction status. Note that the status may change, e.g. a `pending` transaction may become `declined` or `success` may later become `void`.
   */
  
  public void setStatus(final Constants.TransactionStatus status) { this.status = status; }
  ...
  /**
   * @param statusMessage For declined (`success=false`) transactions, the message displayed to the merchant.
   */
  ...
  /**
   * @param subscriptionIds If the transaction is charging or refunding for one or more subscriptions, these are their IDs.
   */
...
- `verify` – a $0 or $1 transaction used to verify billing information which is immediately voided.
  ...
  public Constants.TransactionType getType() { return this.type; }

  
  /**
   * @param type - `authorization` – verifies billing information and places a hold on money in the customer's account.
- `capture` – captures funds held by an authorization and completes a purchase.
- `purchase` – combines the authorization and capture in one transaction.
- `refund` – returns all or a portion of the money collected in a previous transaction to the customer.
- `verify` – a $0 or $1 transaction used to verify billing information which is immediately voided.
  ...
  public void setType(final Constants.TransactionType type) { this.type = type; }
