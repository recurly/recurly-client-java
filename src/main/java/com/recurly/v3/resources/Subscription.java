...
public class Subscription extends Resource {
  ...
  public String getActiveInvoiceId() { return this.activeInvoiceId; }
  ...
  public void setActiveInvoiceId(final String activeInvoiceId) { this.activeInvoiceId = activeInvoiceId; }
  ...
  public BigDecimal getAddOnsTotal() { return this.addOnsTotal; }
  ...
  public void setAddOnsTotal(final BigDecimal addOnsTotal) { this.addOnsTotal = addOnsTotal; }
  ...
  public DateTime getConvertedAt() { return this.convertedAt; }
  ...
  public void setConvertedAt(final DateTime convertedAt) { this.convertedAt = convertedAt; }
  ...
  /**
   * @param couponRedemptions Returns subscription level coupon redemptions that are tied to this subscription.
   */
  ...
  /**
   * @param currentTermEndsAt When the term ends. This is calculated by a plan's interval and `total_billing_cycles` in a term. Subscription changes with a `timeframe=renewal` will be applied on this date.
   */
  ...
  /**
   * @param currentTermStartedAt The start date of the term when the first billing period starts. The subscription term is the length of time that a customer will be committed to a subscription. A term can span multiple billing periods.
   */
  ...
  /**
   * @param gatewayCode If present, this subscription's transactions will use the payment gateway with this code.
   */
  ...
  /**
   * @param pausedAt Null unless subscription is paused or will pause at the end of the current billing period.
   */
  ...
  public List<SubscriptionRampIntervalResponse> getRampIntervals() { return this.rampIntervals; }
  ...
  public void setRampIntervals(final List<SubscriptionRampIntervalResponse> rampIntervals) { this.rampIntervals = rampIntervals; }
  ...
  /**
   * @param remainingPauseCycles Null unless subscription is paused or will pause at the end of the current billing period.
   */
  ...
  /**
   * @param renewalBillingCycles If `auto_renew=true`, when a term completes, `total_billing_cycles` takes this value as the length of subsequent terms. Defaults to the plan's `total_billing_cycles`.
   */
  ...
  public SubscriptionShipping getShipping() { return this.shipping; }
  ...
  public void setShipping(final SubscriptionShipping shipping) { this.shipping = shipping; }
  ...
  public Boolean getStartedWithGift() { return this.startedWithGift; }
  ...
  public void setStartedWithGift(final Boolean startedWithGift) { this.startedWithGift = startedWithGift; }
  ...
  public Constants.SubscriptionState getState() { return this.state; }
  ...
  public void setState(final Constants.SubscriptionState state) { this.state = state; }
  ...
  /**
   * @param totalBillingCycles The number of cycles/billing periods in a term. When `remaining_billing_cycles=0`, if `auto_renew=true` the subscription will renew and a new term will begin, otherwise the subscription will expire.
   */
