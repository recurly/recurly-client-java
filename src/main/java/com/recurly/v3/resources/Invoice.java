...
public class Invoice extends Resource {
   ...
   * endpoint](https://recurly.com/developers/api/v2019-10-10/index.html#operation/list_related_invoices)
  ...
  public void setSubtotalAfterDiscount(final Float subtotalAfterDiscount) {
