...
public class UniqueCouponCode extends Resource {
  ...
  public String getBulkCouponCode() { return this.bulkCouponCode; }
  ...
  public void setBulkCouponCode(final String bulkCouponCode) { this.bulkCouponCode = bulkCouponCode; }
  ...
  public String getBulkCouponId() { return this.bulkCouponId; }
  ...
  public void setBulkCouponId(final String bulkCouponId) { this.bulkCouponId = bulkCouponId; }
  ...
  public Constants.CouponCodeState getState() { return this.state; }
  ...
  public void setState(final Constants.CouponCodeState state) { this.state = state; }
