...
public class Coupon extends Resource {
  ...
  /**
   * @param uniqueCouponCodesCount When this number reaches `max_redemptions` the coupon will no
   *     longer be redeemable.
   */
  public void setUniqueCouponCodesCount(final Integer uniqueCouponCodesCount) {
    this.uniqueCouponCodesCount = uniqueCouponCodesCount;
  }
