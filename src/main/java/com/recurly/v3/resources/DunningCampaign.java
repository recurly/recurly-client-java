...
public class DunningCampaign extends Resource {
  ...
  /**
   * @param defaultCampaign Whether or not this is the default campaign for accounts or plans
   *     without an assigned dunning campaign.
   */
  ...
  /** Dunning Cycle settings. */
  public List<DunningCycle> getDunningCycles() {
