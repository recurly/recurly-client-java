...
public class Site extends Resource {
  ...
  public List<Constants.Features> getFeatures() { return this.features; }
  ...
  public void setFeatures(final List<Constants.Features> features) { this.features = features; }
  ...
  public Constants.SiteMode getMode() { return this.mode; }
  ...
  public void setMode(final Constants.SiteMode mode) { this.mode = mode; }
