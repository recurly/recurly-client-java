...
to configure quantity-based pricing models.
  ...
  /**
   * @param amount The amount of usage. Can be positive, negative, or 0. If the Decimal Quantity feature is enabled, this value will be rounded to nine decimal places.  Otherwise, all digits after the decimal will be stripped. If the usage-based add-on is billed with a percentage, your usage should be a monetary amount formatted in cents (e.g., $5.00 is "500").
   */
  ...
  public DateTime getBilledAt() { return this.billedAt; }
  ...
  public void setBilledAt(final DateTime billedAt) { this.billedAt = billedAt; }
  ...
  /**
   * @param measuredUnitId The ID of the measured unit associated with the add-on the usage record is for.
   */
  ...
  public String getMerchantTag() { return this.merchantTag; }

  
  /**
   * @param merchantTag Custom field for recording the id in your own system associated with the usage, so you can provide auditable usage displays to your customers using a GET on this endpoint.
   */
  
  public void setMerchantTag(final String merchantTag) { this.merchantTag = merchantTag; }
  ...
  /**
   * @param percentageTiers The percentage tiers of the subscription based on the usage_timestamp. If tier_type = flat, percentage_tiers = []. This feature is currently in development and requires approval and enablement, please contact support.
   */
  ...
  public DateTime getRecordingTimestamp() { return this.recordingTimestamp; }
  ...
  public void setRecordingTimestamp(final DateTime recordingTimestamp) { this.recordingTimestamp = recordingTimestamp; }
...
to configure quantity-based pricing models.
  ...
  /**
   * @param tiers The tiers and prices of the subscription based on the usage_timestamp. If tier_type = flat, tiers = []
   */
  ...
  public DateTime getUsageTimestamp() { return this.usageTimestamp; }

  
  /**
   * @param usageTimestamp When the usage actually happened. This will define the line item dates this usage is billed under and is important for revenue recognition.
   */
  
  public void setUsageTimestamp(final DateTime usageTimestamp) { this.usageTimestamp = usageTimestamp; }
