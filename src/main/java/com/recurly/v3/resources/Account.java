...
public class Account extends Resource {
  ...
  @Expose
  private List<ExternalAccountResponse> externalAccounts;
  ...
  public List<ExternalAccountResponse> getExternalAccounts() { return this.externalAccounts; }
  ...
  public void setExternalAccounts(final List<ExternalAccountResponse> externalAccounts) { this.externalAccounts = externalAccounts; }
  ...
  public Boolean getHasActiveSubscription() { return this.hasActiveSubscription; }
  ...
  public void setHasActiveSubscription(final Boolean hasActiveSubscription) { this.hasActiveSubscription = hasActiveSubscription; }
  ...
  public Boolean getHasCanceledSubscription() { return this.hasCanceledSubscription; }
  ...
  public void setHasCanceledSubscription(final Boolean hasCanceledSubscription) { this.hasCanceledSubscription = hasCanceledSubscription; }
  ...
  public Boolean getHasFutureSubscription() { return this.hasFutureSubscription; }
  ...
  public void setHasFutureSubscription(final Boolean hasFutureSubscription) { this.hasFutureSubscription = hasFutureSubscription; }
  ...
  public Boolean getHasLiveSubscription() { return this.hasLiveSubscription; }

  
  /**
   * @param hasLiveSubscription Indicates if the account has a subscription that is either active, canceled, future, or paused.
   */
  
  public void setHasLiveSubscription(final Boolean hasLiveSubscription) { this.hasLiveSubscription = hasLiveSubscription; }
  ...
  public Boolean getHasPastDueInvoice() { return this.hasPastDueInvoice; }
  ...
  public void setHasPastDueInvoice(final Boolean hasPastDueInvoice) { this.hasPastDueInvoice = hasPastDueInvoice; }
  ...
  public Boolean getHasPausedSubscription() { return this.hasPausedSubscription; }
  ...
  public void setHasPausedSubscription(final Boolean hasPausedSubscription) { this.hasPausedSubscription = hasPausedSubscription; }
  ...
  /**
   * @param hostedLoginToken The unique token for automatically logging the account in to the hosted management pages. You may automatically log the user into their hosted management pages by directing the user to: `https://{subdomain}.recurly.com/account/{hosted_login_token}`.
   */
  ...
  /**
   * @param invoiceTemplateId Unique ID to identify an invoice template. Available when the site is on a Pro or Enterprise plan. Used to specify if a non-default invoice template will be used to generate invoices for the account. For sites without multiple invoice templates enabled, the default template will always be used.
   */
  ...
  /**
   * @param preferredLocale Used to determine the language and locale of emails sent on behalf of the merchant to the customer.
   */
  ...
  /**
   * @param preferredTimeZone The [IANA time zone name](https://docs.recurly.com/docs/email-time-zones-and-time-stamps#supported-api-iana-time-zone-names) used to determine the time zone of emails sent on behalf of the merchant to the customer.
   */
