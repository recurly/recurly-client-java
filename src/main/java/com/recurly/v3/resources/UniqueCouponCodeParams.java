...
public class UniqueCouponCodeParams extends Resource {
  ...
  public DateTime getBeginTime() { return this.beginTime; }
  ...
  public void setBeginTime(final DateTime beginTime) { this.beginTime = beginTime; }
  ...
  public void setOrder(final String order) { this.order = order; }
  ...
  /**
   * @param sort Sort field to list newly generated UniqueCouponCodes (should always be `created_at`)
   */
