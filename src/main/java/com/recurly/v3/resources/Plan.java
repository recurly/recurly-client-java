...
a specified cadence of billing periods. The price change could be an increase or decrease.
  ...
  /**
   * @param accountingCode Accounting code for invoice line items for the plan. If no value is provided, it defaults to plan's code.
   */
...
If `false`, only plan add-ons can be used.
  ...
  public Boolean getAllowAnyItemOnSubscriptions() { return this.allowAnyItemOnSubscriptions; }

  
  /**
   * @param allowAnyItemOnSubscriptions Used to determine whether items can be assigned as add-ons to individual subscriptions.
If `true`, items can be assigned as add-ons to individual subscription add-ons.
If `false`, only plan add-ons can be used.

   */
  
  public void setAllowAnyItemOnSubscriptions(final Boolean allowAnyItemOnSubscriptions) { this.allowAnyItemOnSubscriptions = allowAnyItemOnSubscriptions; }
  ...
  /**
   * @param dunningCampaignId Unique ID to identify a dunning campaign. Used to specify if a non-default dunning campaign should be assigned to this plan. For sites without multiple dunning campaigns enabled, the default dunning campaign will always be used.
   */
  ...
  public Constants.IntervalUnit getIntervalUnit() { return this.intervalUnit; }
  ...
  public void setIntervalUnit(final Constants.IntervalUnit intervalUnit) { this.intervalUnit = intervalUnit; }
...
a specified cadence of billing periods. The price change could be an increase or decrease.
  ...
  public Constants.PricingModelType getPricingModel() { return this.pricingModel; }

  
  /**
   * @param pricingModel A fixed pricing model has the same price for each billing period.
A ramp pricing model defines a set of Ramp Intervals, where a subscription changes price on
a specified cadence of billing periods. The price change could be an increase or decrease.

   */
  
  public void setPricingModel(final Constants.PricingModelType pricingModel) { this.pricingModel = pricingModel; }
  ...
  public List<PlanRampInterval> getRampIntervals() { return this.rampIntervals; }
  ...
  public void setRampIntervals(final List<PlanRampInterval> rampIntervals) { this.rampIntervals = rampIntervals; }
  ...
  /**
   * @param setupFeeAccountingCode Accounting code for invoice line items for the plan's setup fee. If no value is provided, it defaults to plan's accounting code.
   */
  ...
  public Constants.RevenueScheduleType getSetupFeeRevenueScheduleType() { return this.setupFeeRevenueScheduleType; }
  ...
  public void setSetupFeeRevenueScheduleType(final Constants.RevenueScheduleType setupFeeRevenueScheduleType) { this.setupFeeRevenueScheduleType = setupFeeRevenueScheduleType; }
  ...
  /**
   * @param totalBillingCycles Automatically terminate subscriptions after a defined number of billing cycles. Number of billing cycles before the plan automatically stops renewing, defaults to `null` for continuous, automatic renewal.
   */
  ...
  public Boolean getTrialRequiresBillingInfo() { return this.trialRequiresBillingInfo; }

  
  /**
   * @param trialRequiresBillingInfo Allow free trial subscriptions to be created without billing info. Should not be used if billing info is needed for initial invoice due to existing uninvoiced charges or setup fee.
   */
  
  public void setTrialRequiresBillingInfo(final Boolean trialRequiresBillingInfo) { this.trialRequiresBillingInfo = trialRequiresBillingInfo; }
  ...
  public Constants.IntervalUnit getTrialUnit() { return this.trialUnit; }
  ...
  public void setTrialUnit(final Constants.IntervalUnit trialUnit) { this.trialUnit = trialUnit; }
