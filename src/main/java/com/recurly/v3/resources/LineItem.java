...
- "carryforwards" can be ignored. They exist to consume any remaining credit balance. A new credit with the same amount will be created and placed back on the account.
  ...
  /**
   * @param accountingCode Internal accounting code to help you reconcile your revenue to the correct ledger. Line items created as part of a subscription invoice will use the plan or add-on's accounting code, otherwise the value will only be present if you define an accounting code when creating the line item.
   */
  ...
  public String getBillForAccountId() { return this.billForAccountId; }
  ...
  public void setBillForAccountId(final String billForAccountId) { this.billForAccountId = billForAccountId; }
  ...
  public BigDecimal getCreditApplied() { return this.creditApplied; }
  ...
  public void setCreditApplied(final BigDecimal creditApplied) { this.creditApplied = creditApplied; }
  ...
  public Constants.FullCreditReasonCode getCreditReasonCode() { return this.creditReasonCode; }
  ...
  public void setCreditReasonCode(final Constants.FullCreditReasonCode creditReasonCode) { this.creditReasonCode = creditReasonCode; }
  ...
  /**
   * @param description Description that appears on the invoice. For subscription related items this will be filled in automatically.
   */
  ...
  /**
   * @param externalSku Optional Stock Keeping Unit assigned to an item. Available when the Credit Invoices feature is enabled.
   */
  ...
  /**
   * @param invoiceNumber Once the line item has been invoiced this will be the invoice's number. If VAT taxation and the Country Invoice Sequencing feature are enabled, invoices will have country-specific invoice numbers for invoices billed to EU countries (ex: FR1001). Non-EU invoices will continue to use the site-level invoice number sequence.
   */
  ...
  /**
   * @param itemCode Unique code to identify an item. Available when the Credit Invoices feature is enabled.
   */
  ...
  /**
   * @param itemId System-generated unique identifier for an item. Available when the Credit Invoices feature is enabled.
   */
...
- "carryforwards" can be ignored. They exist to consume any remaining credit balance. A new credit with the same amount will be created and placed back on the account.
  ...
  public Constants.LegacyCategory getLegacyCategory() { return this.legacyCategory; }
...
- "carryforwards" can be ignored. They exist to consume any remaining credit balance. A new credit with the same amount will be created and placed back on the account.
  ...
  public void setLegacyCategory(final Constants.LegacyCategory legacyCategory) { this.legacyCategory = legacyCategory; }
  ...
  public Constants.LineItemOrigin getOrigin() { return this.origin; }

  
  /**
   * @param origin A credit created from an original charge will have the value of the charge's origin.
   */
  
  public void setOrigin(final Constants.LineItemOrigin origin) { this.origin = origin; }
  ...
  /**
   * @param originalLineItemInvoiceId The invoice where the credit originated. Will only have a value if the line item is a credit created from a previous credit, or if the credit was created from a charge refund.
   */
  ...
  /**
   * @param planCode If the line item is a charge or credit for a plan or add-on, this is the plan's code.
   */
  ...
  /**
   * @param planId If the line item is a charge or credit for a plan or add-on, this is the plan's ID.
   */
  ...
  /**
   * @param previousLineItemId Will only have a value if the line item is a credit created from a previous credit, or if the credit was created from a charge refund.
   */
  ...
  /**
   * @param productCode For plan-related line items this will be the plan's code, for add-on related line items it will be the add-on's code. For item-related line items it will be the item's `external_sku`.
   */
  ...
  public BigDecimal getProrationRate() { return this.prorationRate; }

  
  /**
   * @param prorationRate When a line item has been prorated, this is the rate of the proration. Proration rates were made available for line items created after March 30, 2017. For line items created prior to that date, the proration rate will be `null`, even if the line item was prorated.
   */
  
  public void setProrationRate(final BigDecimal prorationRate) { this.prorationRate = prorationRate; }
  ...
  /**
   * @param quantity This number will be multiplied by the unit amount to compute the subtotal before any discounts or taxes.
   */
  ...
  public String getQuantityDecimal() { return this.quantityDecimal; }

  
  /**
   * @param quantityDecimal A floating-point alternative to Quantity. If this value is present, it will be used in place of Quantity for calculations, and Quantity will be the rounded integer value of this number. This field supports up to 9 decimal places. The Decimal Quantity feature must be enabled to utilize this field.
   */
  
  public void setQuantityDecimal(final String quantityDecimal) { this.quantityDecimal = quantityDecimal; }
  ...
  /**
   * @param refundedQuantity For refund charges, the quantity being refunded. For non-refund charges, the total quantity refunded (possibly over multiple refunds).
   */
  ...
  public String getRefundedQuantityDecimal() { return this.refundedQuantityDecimal; }

  
  /**
   * @param refundedQuantityDecimal A floating-point alternative to Refunded Quantity. For refund charges, the quantity being refunded. For non-refund charges, the total quantity refunded (possibly over multiple refunds). The Decimal Quantity feature must be enabled to utilize this field.
   */
  
  public void setRefundedQuantityDecimal(final String refundedQuantityDecimal) { this.refundedQuantityDecimal = refundedQuantityDecimal; }
  ...
  public Constants.LineItemRevenueScheduleType getRevenueScheduleType() { return this.revenueScheduleType; }
  ...
  public void setRevenueScheduleType(final Constants.LineItemRevenueScheduleType revenueScheduleType) { this.revenueScheduleType = revenueScheduleType; }
  ...
  /**
   * @param startDate If an end date is present, this is value indicates the beginning of a billing time range. If no end date is present it indicates billing for a specific date.
   */
  ...
  public Constants.LineItemState getState() { return this.state; }

  
  /**
   * @param state Pending line items are charges or credits on an account that have not been applied to an invoice yet. Invoiced line items will always have an `invoice_id` value.
   */
  
  public void setState(final Constants.LineItemState state) { this.state = state; }
  ...
  /**
   * @param subscriptionId If the line item is a charge or credit for a subscription, this is its ID.
   */
  ...
  /**
   * @param taxExempt `true` exempts tax on charges, `false` applies tax on charges. If not defined, then defaults to the Plan and Site settings. This attribute does not work for credits (negative line items). Credits are always applied post-tax. Pre-tax discounts should use the Coupons feature.
   */
  ...
  /**
   * @param taxInclusive Determines whether or not tax is included in the unit amount. The Tax Inclusive Pricing feature (separate from the Mixed Tax Pricing feature) must be enabled to utilize this flag.
   */
  ...
  public Constants.LineItemType getType() { return this.type; }

  
  /**
   * @param type Charges are positive line items that debit the account. Credits are negative line items that credit the account.
   */
  
  public void setType(final Constants.LineItemType type) { this.type = type; }
