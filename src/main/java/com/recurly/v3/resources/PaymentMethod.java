...
public class PaymentMethod extends Resource {
  ...
  public Constants.AccountType getAccountType() { return this.accountType; }
  ...
  public void setAccountType(final Constants.AccountType accountType) { this.accountType = accountType; }
  ...
  public String getBillingAgreementId() { return this.billingAgreementId; }

  
  /**
   * @param billingAgreementId Billing Agreement identifier. Only present for Amazon or Paypal payment methods.
   */
  
  public void setBillingAgreementId(final String billingAgreementId) { this.billingAgreementId = billingAgreementId; }
  ...
  public String getCcBinCountry() { return this.ccBinCountry; }

  
  /**
   * @param ccBinCountry The 2-letter ISO 3166-1 alpha-2 country code associated with the credit card BIN, if known by Recurly. Available on the BillingInfo object only. Available when the BIN country lookup feature is enabled.
   */
  
  public void setCcBinCountry(final String ccBinCountry) { this.ccBinCountry = ccBinCountry; }
  ...
  /**
   * @param lastFour Credit card number's last four digits. Will refer to bank account if payment method is ACH.
   */
  ...
  public String getLastTwo() { return this.lastTwo; }
  ...
  public void setLastTwo(final String lastTwo) { this.lastTwo = lastTwo; }
  ...
  public Constants.PaymentMethod getObject() { return this.object; }
  ...
  public void setObject(final Constants.PaymentMethod object) { this.object = object; }
  ...
  public String getRoutingNumberBank() { return this.routingNumberBank; }
  ...
  public void setRoutingNumberBank(final String routingNumberBank) { this.routingNumberBank = routingNumberBank; }
  ...
  /**
   * @param username Username of the associated payment method. Currently only associated with Venmo.
   */
