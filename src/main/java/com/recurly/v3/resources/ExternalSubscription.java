...
public class ExternalSubscription extends Resource {
  ...
  public String getAppIdentifier() { return this.appIdentifier; }
  ...
  public void setAppIdentifier(final String appIdentifier) { this.appIdentifier = appIdentifier; }
  ...
  /**
   * @param autoRenew An indication of whether or not the external subscription will auto-renew at the expiration date.
   */
  ...
  /**
   * @param externalId The id of the subscription in the external systems., I.e. Apple App Store or Google Play Store.
   */
  ...
  public ExternalProductReferenceMini getExternalProductReference() { return this.externalProductReference; }
  ...
  public void setExternalProductReference(final ExternalProductReferenceMini externalProductReference) { this.externalProductReference = externalProductReference; }
  ...
  /**
   * @param id System-generated unique identifier for an external subscription ID, e.g. `e28zov4fw0v2`.
   */
  ...
  public DateTime getLastPurchased() { return this.lastPurchased; }

  
  /**
   * @param lastPurchased When a new billing event occurred on the external subscription in conjunction with a recent billing period, reactivation or upgrade/downgrade.
   */
  
  public void setLastPurchased(final DateTime lastPurchased) { this.lastPurchased = lastPurchased; }
