...
public class Entitlement extends Resource {
  ...
  public CustomerPermission getCustomerPermission() { return this.customerPermission; }
  ...
  public void setCustomerPermission(final CustomerPermission customerPermission) { this.customerPermission = customerPermission; }
  ...
  public List<GrantedBy> getGrantedBy() { return this.grantedBy; }
  ...
  public void setGrantedBy(final List<GrantedBy> grantedBy) { this.grantedBy = grantedBy; }
