...
public class AccountBalanceAmount extends Resource {
  ...
  public BigDecimal getAvailableCreditAmount() { return this.availableCreditAmount; }

  
  /**
   * @param availableCreditAmount Total amount of the open balances on credit invoices for the account.
   */
  
  public void setAvailableCreditAmount(final BigDecimal availableCreditAmount) { this.availableCreditAmount = availableCreditAmount; }
