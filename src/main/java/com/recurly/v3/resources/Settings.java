...
- none:      No Address
  ...
  public Constants.AddressRequirement getBillingAddressRequirement() { return this.billingAddressRequirement; }

  
  /**
   * @param billingAddressRequirement - full:      Full Address (Street, City, State, Postal Code and Country)
- streetzip: Street and Postal Code only
- zip:       Postal Code only
- none:      No Address
  ...
  public void setBillingAddressRequirement(final Constants.AddressRequirement billingAddressRequirement) { this.billingAddressRequirement = billingAddressRequirement; }
