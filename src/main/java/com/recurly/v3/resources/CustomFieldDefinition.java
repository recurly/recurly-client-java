...
public class CustomFieldDefinition extends Resource {
  ...
  /**
   * Used by the API to identify the field or reading and writing. The name can only be used once
   * per Recurly object type.
   */
  @SerializedName("name")
  @Expose
  private String name;
  ...
  /**
   * @param displayName Used to label the field when viewing and editing the field in Recurly's
   *     admin UI.
   */
  ...
  /**
   * @param name Used by the API to identify the field or reading and writing. The name can only be
   *     used once per Recurly object type.
   */
  ...
  /**
   * @param userAccess The access control applied inside Recurly's admin UI: - `api_only` - No one
