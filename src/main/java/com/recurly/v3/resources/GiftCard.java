...
public class GiftCard extends Resource {
  ...
  /**
   * @param balance The remaining credit on the recipient account associated with this gift card. Only has a value once the gift card has been redeemed. Can be used to create gift card balance displays for your customers.
   */
  ...
  public DateTime getDeliveredAt() { return this.deliveredAt; }

  
  /**
   * @param deliveredAt When the gift card was sent to the recipient by Recurly via email, if method was email and the "Gift Card Delivery" email template was enabled. This will be empty for post delivery or email delivery where the email template was disabled.
   */
  
  public void setDeliveredAt(final DateTime deliveredAt) { this.deliveredAt = deliveredAt; }
  ...
  public GiftCardDelivery getDelivery() { return this.delivery; }
  ...
  public void setDelivery(final GiftCardDelivery delivery) { this.delivery = delivery; }
  ...
  public String getGifterAccountId() { return this.gifterAccountId; }
  ...
  public void setGifterAccountId(final String gifterAccountId) { this.gifterAccountId = gifterAccountId; }
  ...
  public String getPurchaseInvoiceId() { return this.purchaseInvoiceId; }
  ...
  public void setPurchaseInvoiceId(final String purchaseInvoiceId) { this.purchaseInvoiceId = purchaseInvoiceId; }
  ...
  public String getRecipientAccountId() { return this.recipientAccountId; }

  
  /**
   * @param recipientAccountId The ID of the account that redeemed the gift card redemption code.  Does not have a value until gift card is redeemed.
   */
  
  public void setRecipientAccountId(final String recipientAccountId) { this.recipientAccountId = recipientAccountId; }
  ...
  public String getRedemptionCode() { return this.redemptionCode; }

  
  /**
   * @param redemptionCode The unique redemption code for the gift card, generated by Recurly. Will be 16 characters, alphanumeric, displayed uppercase, but accepted in any case at redemption. Used by the recipient account to create a credit in the amount of the `unit_amount` on their account.
   */
  
  public void setRedemptionCode(final String redemptionCode) { this.redemptionCode = redemptionCode; }
  ...
  public String getRedemptionInvoiceId() { return this.redemptionInvoiceId; }

  
  /**
   * @param redemptionInvoiceId The ID of the invoice for the gift card redemption made by the recipient.  Does not have a value until gift card is redeemed.
   */
  
  public void setRedemptionInvoiceId(final String redemptionInvoiceId) { this.redemptionInvoiceId = redemptionInvoiceId; }
