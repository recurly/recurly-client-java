...
public class PlanRampInterval extends Request {
  ...
  public List<PlanRampPricing> getCurrencies() { return this.currencies; }
  ...
  public void setCurrencies(final List<PlanRampPricing> currencies) { this.currencies = currencies; }
