...
public class GiftCardRedeem extends Request {
  ...
  public AccountReference getRecipientAccount() { return this.recipientAccount; }
  ...
  public void setRecipientAccount(final AccountReference recipientAccount) { this.recipientAccount = recipientAccount; }
