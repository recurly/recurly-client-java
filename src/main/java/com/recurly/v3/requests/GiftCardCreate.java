...
public class GiftCardCreate extends Request {
  ...
  /**
   * @param gifterAccount Block of account details for the gifter. This references an existing
   *     account_code.
   */
  public void setGifterAccount(final AccountPurchase gifterAccount) {
