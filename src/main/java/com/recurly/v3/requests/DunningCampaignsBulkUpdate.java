...
public class DunningCampaignsBulkUpdate extends Request {
  ...
  /**
   * @param planCodes List of `plan_codes` associated with the Plans for which the dunning campaign should be updated. Required unless `plan_ids` is present.
   */
  ...
  /**
   * @param planIds List of `plan_ids` associated with the Plans for which the dunning campaign should be updated. Required unless `plan_codes` is present.
   */
  
  public void setPlanIds(final List<String> planIds) { this.planIds = planIds; }
