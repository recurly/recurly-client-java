...
public class SubscriptionUpdate extends Request {
  ...
  /**
   * @param customerNotes Specify custom notes to add or override Customer Notes. Custom notes will stay with a subscription on all renewals.
   */
  ...
  public SubscriptionShippingUpdate getShipping() { return this.shipping; }
  ...
  public void setShipping(final SubscriptionShippingUpdate shipping) { this.shipping = shipping; }
  ...
  /**
   * @param termsAndConditions Specify custom notes to add or override Terms and Conditions. Custom notes will stay with a subscription on all renewals.
   */
