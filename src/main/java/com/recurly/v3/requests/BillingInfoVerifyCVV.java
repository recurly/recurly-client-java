...
public class BillingInfoVerifyCVV extends Request {
  ...
  public String getVerificationValue() { return this.verificationValue; }
  ...
  public void setVerificationValue(final String verificationValue) { this.verificationValue = verificationValue; }
