...
public class ExternalTransaction extends Request {
  ...
  /**
   * @param collectedAt Datetime that the external payment was collected. Defaults to current datetime.
   */
  ...
  public Constants.ExternalPaymentMethod getPaymentMethod() { return this.paymentMethod; }
  ...
  public void setPaymentMethod(final Constants.ExternalPaymentMethod paymentMethod) { this.paymentMethod = paymentMethod; }
