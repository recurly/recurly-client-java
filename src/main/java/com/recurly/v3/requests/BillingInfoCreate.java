...
public class BillingInfoCreate extends Request {
  ...
  public void setAccountNumber(final String accountNumber) { this.accountNumber = accountNumber; }
  ...
  public Constants.AchAccountType getAccountType() { return this.accountType; }
  ...
  public void setAccountType(final Constants.AchAccountType accountType) { this.accountType = accountType; }
  ...
  public Boolean getBackupPaymentMethod() { return this.backupPaymentMethod; }

  
  /**
   * @param backupPaymentMethod The `backup_payment_method` field is used to designate a billing info as a backup on the account that will be tried if the initial billing info used for an invoice is declined. All payment methods, including the billing info marked `primary_payment_method` can be set as a backup. An account can have a maximum of 1 backup, if a user sets a different payment method as a backup, the existing backup will no longer be marked as such.
   */
  
  public void setBackupPaymentMethod(final Boolean backupPaymentMethod) { this.backupPaymentMethod = backupPaymentMethod; }

  
  public Constants.CardType getCardType() { return this.cardType; }
  ...
  public void setCardType(final Constants.CardType cardType) { this.cardType = cardType; }
  ...
  public Constants.ExternalHppType getExternalHppType() { return this.externalHppType; }

  
  /**
   * @param externalHppType Use for Adyen HPP billing info. This should only be used as part of a pending purchase request, when the billing info is nested inside an account object.
   */
  
  public void setExternalHppType(final Constants.ExternalHppType externalHppType) { this.externalHppType = externalHppType; }
  ...
  public String getFraudSessionId() { return this.fraudSessionId; }
  ...
  public void setFraudSessionId(final String fraudSessionId) { this.fraudSessionId = fraudSessionId; }
  ...
  /**
   * @param gatewayCode An identifier for a specific payment gateway. Must be used in conjunction with `gateway_token`.
   */
  ...
  public String getGatewayToken() { return this.gatewayToken; }

  
  /**
   * @param gatewayToken A token used in place of a credit card in order to perform transactions. Must be used in conjunction with `gateway_code`.
   */
  
  public void setGatewayToken(final String gatewayToken) { this.gatewayToken = gatewayToken; }
  ...
  /**
   * @param iban The International Bank Account Number, up to 34 alphanumeric characters comprising a country code; two check digits; and a number that includes the domestic bank account number, branch identifier, and potential routing information
   */
  
  public void setIban(final String iban) { this.iban = iban; }
  ...
  /**
   * @param ipAddress *STRONGLY RECOMMENDED* Customer's IP address when updating their billing information.
   */
  ...
  public Constants.OnlineBankingPaymentType getOnlineBankingPaymentType() { return this.onlineBankingPaymentType; }

  
  /**
   * @param onlineBankingPaymentType Use for Online Banking billing info. This should only be used as part of a pending purchase request, when the billing info is nested inside an account object.
   */
  
  public void setOnlineBankingPaymentType(final Constants.OnlineBankingPaymentType onlineBankingPaymentType) { this.onlineBankingPaymentType = onlineBankingPaymentType; }
  ...
  public Boolean getPrimaryPaymentMethod() { return this.primaryPaymentMethod; }
  ...
  public void setPrimaryPaymentMethod(final Boolean primaryPaymentMethod) { this.primaryPaymentMethod = primaryPaymentMethod; }
  ...
  public String getRoutingNumber() { return this.routingNumber; }
  ...
  public void setRoutingNumber(final String routingNumber) { this.routingNumber = routingNumber; }
  ...
  /**
   * @param sortCode Bank identifier code for UK based banks. Required for Bacs based billing infos. (Bacs only)
   */
  
  public void setSortCode(final String sortCode) { this.sortCode = sortCode; }
  ...
  public String getTaxIdentifier() { return this.taxIdentifier; }

  
  /**
   * @param taxIdentifier Tax identifier is required if adding a billing info that is a consumer card in Brazil or in Argentina. This would be the customer's CPF/CNPJ (Brazil) and CUIT (Argentina). CPF, CNPJ and CUIT are tax identifiers for all residents who pay taxes in Brazil and Argentina respectively.
   */
  
  public void setTaxIdentifier(final String taxIdentifier) { this.taxIdentifier = taxIdentifier; }
  ...
  public Constants.TaxIdentifierType getTaxIdentifierType() { return this.taxIdentifierType; }

  
  /**
   * @param taxIdentifierType This field and a value of `cpf`, `cnpj` or `cuit` are required if adding a billing info that is an elo or hipercard type in Brazil or in Argentina.
   */
  
  public void setTaxIdentifierType(final Constants.TaxIdentifierType taxIdentifierType) { this.taxIdentifierType = taxIdentifierType; }
  ...
  /**
   * @param tokenId A token [generated by Recurly.js](https://recurly.com/developers/reference/recurly-js/#getting-a-token).
   */
  ...
  public Constants.AchType getType() { return this.type; }

  
  /**
   * @param type The payment method type for a non-credit card based billing info. `bacs` and `becs` are the only accepted values.
   */
  
  public void setType(final Constants.AchType type) { this.type = type; }
