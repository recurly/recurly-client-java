...
public class InvoiceCreate extends Request {
  ...
  /**
   * @param chargeCustomerNotes This will default to the Customer Notes text specified on the Invoice Settings for charge invoices. Specify custom notes to add or override Customer Notes on charge invoices.
   */
  ...
  /**
   * @param creditCustomerNotes This will default to the Customer Notes text specified on the Invoice Settings for credit invoices. Specify customer notes to add or override Customer Notes on credit invoices.
   */
